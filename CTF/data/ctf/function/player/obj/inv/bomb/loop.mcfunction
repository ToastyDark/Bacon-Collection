...
$execute if score $ctf_bomb_slot_temp value matches 0.. run item replace entity @s container.$(temp_bomb_slot) with minecraft:tnt[max_stack_size=1,consumable={consume_seconds:50,animation:"eat",has_consume_particles:false}]
