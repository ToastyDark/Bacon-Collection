...
execute if score $ctf_lobby_time value matches ..20 unless score %ctf_queue_tally_all value matches 2.. run scoreboard players set $ctf_lobby_timer_paused value 1
