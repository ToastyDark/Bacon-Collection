...
execute if entity @s[scores={value=1}] run ride @n[distance=..2,type=arrow,tag=ctf_healing_arrow] mount @s
execute if entity @s[scores={value=200..}] as @n[type=marker,tag=new] run tag @s remove new
