...
execute if score $bomb_respawn_cd value matches 0 if score $bomb_respawn_cd_d value matches 0 run function ctf:game/_bomb/place/timer/end with storage ctf:game
