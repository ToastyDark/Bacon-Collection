...
execute if data storage ctf:temp {loading_map:done} unless data storage ctf:temp {loading_map_done:true} run schedule function ctf:lobby/load_map/done 1t replace