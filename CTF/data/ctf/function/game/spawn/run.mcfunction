...
$execute if entity @s[tag=ctf_has_bomb,team=ctf_team$(team_ops),nbt={OnGround:true}] run function ctf:game/_bomb/success/success with storage ctf:game team$(team_num)
