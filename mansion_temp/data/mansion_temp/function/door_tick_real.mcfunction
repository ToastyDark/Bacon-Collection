...
execute as @e[tag=was_holding_tripwire_hook] run playsound minecraft:block.iron_door.open master @s ~ ~ ~
execute as @e[tag=was_holding_tripwire_hook] run clear @s tripwire_hook 1
execute as @e[tag=was_holding_tripwire_hook] as @e[type=minecraft:marker,distance=..2] run function mansion_temp:door_open
