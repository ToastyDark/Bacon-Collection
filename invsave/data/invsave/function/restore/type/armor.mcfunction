# Head
$data modify block ~ ~ ~ Items insert 0 from storage invsave $(path).$(id).armor.head
...
# Chest
$data modify block ~ ~ ~ Items insert 1 from storage invsave $(path).$(id).armor.chest
...
# Legs
$data modify block ~ ~ ~ Items insert 2 from storage invsave $(path).$(id).armor.legs
...
# Feet
$data modify block ~ ~ ~ Items insert 3 from storage invsave $(path).$(id).armor.feet
