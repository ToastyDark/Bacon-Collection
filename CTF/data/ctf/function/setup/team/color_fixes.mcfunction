...
# Aqua
$execute if data storage ctf:game team$(team_num){flag_color:aqua} run data modify storage ctf:game team$(team_num).flag_color set value light_blue
$execute if data storage ctf:game team$(team_num){ops_flag_color:aqua} run data modify storage ctf:game team$(team_num).ops_flag_color set value light_blue