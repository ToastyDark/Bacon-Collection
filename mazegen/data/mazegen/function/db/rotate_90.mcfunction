...
execute as @e[type=marker,tag=mazegen_currently_picked_rot,limit=1] run tag @s remove mazegen_currently_picked_rot
execute as @e[type=marker,tag=mazegen_currently_picked_rot,limit=1] run tag @s remove mazegen_needs_90_rot
