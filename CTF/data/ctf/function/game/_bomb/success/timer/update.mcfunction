...
# Update Display
data modify entity @e[type=text_display,tag=ctf_bombsite_timer,limit=1] text set value '["",{"score":{"name":"$bomb_explode_timer","objective":"value"},"bold":true,"color":"gold"},{"text":".","bold":true,"color":"gold"},{"score":{"name":"$bomb_explode_timer_d","objective":"value"},"bold":true,"color":"gold"},{"text":"s","bold":true,"color":"gold"}]'