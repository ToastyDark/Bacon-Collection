...
execute unless entity @e[type=interaction,tag=door_interaction,distance=..1] run summon interaction ~-.1 ~ ~-.1 {Tags:[deletable,door_interaction], width:1.2, height:2.2}
