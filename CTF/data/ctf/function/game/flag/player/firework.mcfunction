...
# Spawn firework
$execute at @s run summon firework_rocket ~ ~ ~ {Life:20,LifeTime:45,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"small_ball",has_twinkle:true,colors:[I;$(op_color_dec)]}]}}}}
