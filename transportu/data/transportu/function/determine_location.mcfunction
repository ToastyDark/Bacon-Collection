...
# Colorfall
execute if items entity @s weapon.* minecraft:potion[custom_data={destination:colorfall}] run function transportu:teleport {location:"-1090 122 1000", color:"color:[1.0,0.24,0.19]"}
