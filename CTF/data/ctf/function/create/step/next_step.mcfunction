...
execute if entity @s[scores={ctf_create_step=3}] run function ctf:create/step/3/msg
...
execute if entity @s[scores={ctf_create_step=5}] run function ctf:create/step/5/msg
execute if entity @s[scores={ctf_create_step=6}] run function ctf:create/step/6/msg
