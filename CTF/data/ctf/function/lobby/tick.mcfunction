...
execute if data storage ctf:temp {loading_map:done} unless data storage ctf:temp {loading_map_done:true} run function ctf:lobby/load_map/done with storage ctf:game