schedule function mansion:post_office/elevator/elevator_sound 1t
schedule function mansion:post_office/elevator/elevator_sound 110t append
...
schedule function mansion:post_office/elevator/elevator_end 200t append
