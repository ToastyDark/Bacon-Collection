...
scoreboard players reset @s mq.ctf_note_hangup.mmp
...
scoreboard players reset @s mq.ctf_note_lobby.mmp
...
scoreboard players reset @s mq.ctf_note_rush.mmp
...
scoreboard players reset @s mq.ctf_note_silt.mmp
...
scoreboard players reset @s mq.test.mmp
