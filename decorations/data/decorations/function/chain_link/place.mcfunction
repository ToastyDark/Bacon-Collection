...
$execute as @e[tag=chain_decoration_marker] at @s rotated as @s run summon minecraft:block_display ^ ^ ^ {block_state:{Name:iron_chain},Tags:["chain_decoration"], Rotation:[$(rotation)]}
