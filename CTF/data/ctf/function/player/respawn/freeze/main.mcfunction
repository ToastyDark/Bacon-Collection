...
execute if entity @s[scores={ctf_respawn_freeze_cd=12..}] run attribute @s minecraft:movement_speed modifier remove ctf_respawn_cd_mve
execute if entity @s[scores={ctf_respawn_freeze_cd=12..}] run attribute @s minecraft:jump_strength modifier remove ctf_respawn_cd_jmp
execute if entity @s[scores={ctf_respawn_freeze_cd=12..}] run scoreboard players reset @s ctf_respawn_freeze_cd