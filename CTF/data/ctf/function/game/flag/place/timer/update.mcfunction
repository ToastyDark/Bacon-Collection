...
$execute if score $flag$(team_ops)_respawn_cd value matches 0 if score $flag$(team_ops)_respawn_cd_d value matches 0 run function ctf:game/flag/place/timer/end with storage ctf:game team$(team_ops)
