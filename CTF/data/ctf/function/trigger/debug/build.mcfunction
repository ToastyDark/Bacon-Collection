...
# Team 1 Data
    ...
    # Spawn Point
        ...
        #x
        execute if data storage ctf:map desert_maze.team1.spawn.x run data modify storage ctf:temp debug_msg append value '[{"text":"\\n","interpret":true},{"text":"    x: ","bold":false,"color":"white"},{"nbt":"desert_maze.team1.spawn.x","storage":"ctf:map","interpret":false,"color":"gold","bold":true}]'
        ...
        #y
        execute if data storage ctf:map desert_maze.team1.spawn.y run data modify storage ctf:temp debug_msg append value '[{"text":"\\n","interpret":true},{"text":"    y: ","bold":false,"color":"white"},{"nbt":"desert_maze.team1.spawn.y","storage":"ctf:map","interpret":false,"color":"gold","bold":true}]'
        ...
        #z
        execute if data storage ctf:map desert_maze.team1.spawn.z run data modify storage ctf:temp debug_msg append value '[{"text":"\\n","interpret":true},{"text":"    z: ","bold":false,"color":"white"},{"nbt":"desert_maze.team1.spawn.z","storage":"ctf:map","interpret":false,"color":"gold","bold":true}]'
        ...
        #rx
        execute if data storage ctf:map desert_maze.team1.spawn.rx run data modify storage ctf:temp debug_msg append value '[{"text":"\\n","interpret":true},{"text":"    rx: ","bold":false,"color":"white"},{"nbt":"desert_maze.team1.spawn.rx","storage":"ctf:map","interpret":false,"color":"gold","bold":true}]'
        ...
        #ry
        execute if data storage ctf:map desert_maze.team1.spawn.ry run data modify storage ctf:temp debug_msg append value '[{"text":"\\n","interpret":true},{"text":"    ry: ","bold":false,"color":"white"},{"nbt":"desert_maze.team1.spawn.ry","storage":"ctf:map","interpret":false,"color":"gold","bold":true}]'
