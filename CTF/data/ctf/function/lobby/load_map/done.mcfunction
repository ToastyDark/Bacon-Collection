...
execute if score $ctf_lobby_time value matches 1.. if score $ctf_lobby_timer_paused value matches 1 run schedule function ctf:lobby/load_map/turn_off 1s append
