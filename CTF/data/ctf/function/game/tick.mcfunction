...
execute if data storage ctf:game bomb{stolen:true} unless entity @a[tag=ctf_has_bomb_team1] run function ctf:game/bomb/return/start with storage ctf:game team1
execute if data storage ctf:game bomb{stolen:true} unless entity @a[tag=ctf_has_bomb_team2] run function ctf:game/bomb/return/start with storage ctf:game team2