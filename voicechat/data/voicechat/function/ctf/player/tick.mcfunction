...
execute as @a[scores={ctf_comms_change_cd=5..}] run scoreboard players reset @s ctf_comms_change_cd
execute as @a[scores={ctf_comms_change_cd=4..}] run stopsound @s master minecraft:entity.guardian.attack