...
execute if data storage ctf:temp {loading_map:active} if score $ctf_lobby_time value matches ..10 run return run title @s actionbar {"text":"Cannot toggle timer while map is loading","bold": true,"color": "red"}
