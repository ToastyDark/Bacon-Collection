...
execute if score $ctf_lobby_time value matches 5 run playsound minecraft:block.note_block.hat master @s ~ ~ ~ 0.2 0.5 0.1
...
execute if score $ctf_lobby_time value matches 4 run playsound minecraft:block.note_block.hat master @s ~ ~ ~ 0.2 0.6 0.1
...
execute if score $ctf_lobby_time value matches 3 run playsound minecraft:block.note_block.hat master @s ~ ~ ~ 0.2 0.7 0.1
execute if score $ctf_lobby_time value matches 4 run playsound minecraft:block.bell.resonate master @s ~ ~ ~ 1 0.7 1
...
execute if score $ctf_lobby_time value matches 2 run playsound minecraft:block.note_block.hat master @s ~ ~ ~ 0.2 0.8 0.1
...
execute if score $ctf_lobby_time value matches 1 run playsound minecraft:block.note_block.hat master @s ~ ~ ~ 0.2 0.9 0.1
