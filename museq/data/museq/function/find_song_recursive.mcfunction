...
# match yayy
execute if score @s museq.id = @s museq.temp run function museq:tick_song with storage museq:temp_check players[0]
...
execute unless score @s museq.id = @s museq.temp run function museq:find_song