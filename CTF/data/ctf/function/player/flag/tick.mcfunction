...
execute if entity @s[team=ctf_team1] run function ctf:player/flag/inv_check with storage team1
execute if entity @s[team=ctf_team2] run function ctf:player/flag/inv_check with storage team2