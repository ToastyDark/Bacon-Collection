...
execute if score $ctf_lobby_time value matches 1.. unless score $ctf_lobby_timer_paused value matches 1 run schedule function ctf:lobby/timer/remove 2s append
execute if score $ctf_lobby_time value matches 1.. if score $ctf_lobby_timer_paused value matches 1 run schedule function ctf:lobby/load_map/turn_off 2s append